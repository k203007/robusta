...
from robusta.core.reporting.blocks import Finding, MarkdownBlock
from robusta.core.sinks.msteams.msteams_sink import MsTeamsSink, MsTeamsSinkConfig
...
Robusta's Recommendation: Remove this pod's CPU limit entirely. <https://github.com/robusta-dev/alert-explanations/wiki/CPUThrottlingHigh-(Prometheus-Alert)#no-limits|This is safe as long as other pods have somewhat-accurate CPU requests>"""
    ...
    finding.enrichments.append(Enrichment([jpg_file, svg_file1, text_file]))
    finding.enrichments.append(Enrichment([diff, list_block, markdown, markdown2]))
    finding.enrichments.append(
        Enrichment([diff, list_block, markdown, markdown2, table])
    )
    ...
    hook_url = "https://robusta650.webhook.office.com/webhookb2/b8b2b92a-02e9-4f5b-9c6f-3b77010d9cc6@34408606-07e6-4a82-98ac-c3668f4e57f5/IncomingWebhook/ddfa5d7bf8e748089162a2b508a01376/534d0969-a8b0-4250-9971-003bee703700"
